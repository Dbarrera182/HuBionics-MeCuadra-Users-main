...
import 'package:me_cuadra_users/services/notifications/auction_notifications.dart';
...
class AuctionPage extends StatefulWidget {
  ...
  UserModel user;
  AuctionPage({Key? key, required this.residenceList, required this.user})
      : super(key: key);
...
class _AuctionPageState extends State<AuctionPage> {
  ...
  Widget _title() {
    DateTime auctionDate = DateTime.parse(widget.residenceList[0].auctionDate!);
    return Text(
      'Subastas express del\n' +
    ...
    return Stack(children: [
      Container(
          ...
          child: Padding(
            ...
            child: Text(
                'Orden en subasta #' +
                    widget.residenceList[index].auctionOrder.toString(),
                style: GoogleFonts.montserrat(
                    color: Colors.white,
                    fontSize: 16,
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: GestureDetector(
                                          onTap: () async {
                                            var auctionsNotificationPref =
                                                await AuctionNotificationPreferences()
                                                    .loadData();
                                            if (idsResidence.contains(widget
                                                .residenceList[index].id!)) {
                                              setState(() {
                                                int ind = idsResidence.indexOf(
                                                    widget.residenceList[index]
                                                        .id!);
                                                cancelAuctionNotifications(
                                                    auctionsNotificationPref
                                                        .idsNotification![ind]);
                                                auctionsNotificationPref
                                                    .idsNotification!
                                                    .removeAt(ind);
                                                auctionsNotificationPref
                                                    .idsResidence!
                                                    .removeAt(ind);
                                                AuctionNotificationPreferences()
                                                    .saveData(
                                                        auctionsNotificationPref);
                                                idsResidence.removeAt(ind);
                                              });
                                            } else {
                                              ...
                                              setState(() {
                                                idsResidence.add(widget
                                                    .residenceList[index].id!);
                                              });
                                            }
                                          },
                                          child: idsResidence.contains(widget
                                                  .residenceList[index].id!)
                                              ? CircleAvatar(
                                                  radius: 28,
